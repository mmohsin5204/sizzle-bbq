        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
             ...
             <ul className="space-y-4">
                ...
                <li>
                  <Link to="/menu" className="text-gray-500 hover:text-primary transition-colors">Menu</Link>
                </li>
                <li>
          ...
          <div>
             ...
             <ul className="space-y-4">
                <li>
                  <Link to="/menu?category=Burgers" className="text-gray-500 hover:text-primary transition-colors">Burgers</Link>
                </li>
                <li>
                  <Link to="/menu?category=Tikka" className="text-gray-500 hover:text-primary transition-colors">Tikka</Link>
                </li>
                <li>
                  <Link to="/menu?category=Kebabs" className="text-gray-500 hover:text-primary transition-colors">Kebabs</Link>
                </li>
                <li>
                  <Link to="/menu?category=Drinks" className="text-gray-500 hover:text-primary transition-colors">Drinks</Link>
                </li>
             </ul>
          </div>
